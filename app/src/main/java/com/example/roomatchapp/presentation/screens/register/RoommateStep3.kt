...
fun RoommateStep3(
    ...
    Box(
        ...
        if(viewModel.isLoadingBio){
            LoadingAnimation(isLoading = viewModel.isLoadingBio)
        }
        else {
            Column(
                ...
                FlowRow {
                    lookingForRoomies.forEach { attr ->
                        ...
                        Button(
                            ...
                            Text(
                                text = attr.name.replace("_", " ").uppercase(),
                                fontSize = MaterialTheme.typography.titleSmall.fontSize,
                                fontWeight = FontWeight.Bold,
                                maxLines = 1,
                                softWrap = false,
                ...
                CapsuleTextField(
                    ...
                    onValueChange = { viewModel.updatePersonalBio(it)},
                ...
                Button(
                    onClick = onContinue,
                    enabled = viewModel.validateRoommateStep3(),
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(50.dp),
                    colors = ButtonDefaults.buttonColors(
